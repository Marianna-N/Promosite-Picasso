            ...
            return this.each(function(){
                ...
                $(".final").click(function(e){
                    ...
                    if (userAnswer.index() == -1 && !reviewQuiz) {
						...
						resultHTML += "<p class=\"test_results\" style=\"margin-top:25px; text-align: center\">Все картины нарисовала Мария Орлова, бухгалтер с двадцатилетним стажем.</p>";
						resultHTML += "<p class=\"test_results\" style=\"margin-top:25px; text-align: center\">Будь как Мария Орлова - нарисуй шедевры сам!</p>";
